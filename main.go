...
func main() {
	remoteAPIURL := []string{
		"https://citristrip.com/paint-varnish-stripping-gel-32-oz/",
		"https://citristrip.com/paint-varnish-stripping-gel/",
		"https://citristrip.com/paint-varnish-stripping-aerosol/",
		"https://citristrip.com/paint-varnish-stripping-paste-tub/",
	} // URL to fetch HTML content from
	localFilePath := "citristrip.html" // Path where HTML file will be stored
